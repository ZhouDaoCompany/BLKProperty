...
//    var bWebImage: Bool!
    ...
    private func initUI() {
        ...
        scView = UIScrollView.init(frame: self.bounds)
        ...
        pageControl = UIPageControl.init(frame: CGRect(x: CGFloat(0.0), y: HEIGHT - 20, width: WIDTH, height: 20))
   ...
   private func stopAds() {
    ...
    private func reloadImages() {
        ...
        if delegate != nil {
            ...
            imgPrev.image = UIImage(named:  arrImage[prev] as! String)
            imgCurrent.image = UIImage(named:  arrImage[indexShow] as! String)
            imgNext.image = UIImage(named:  arrImage[next] as! String)
        }
